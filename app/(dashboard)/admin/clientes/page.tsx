        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
              ...
              Todos os Arquivos do Cliente (Google Drive)
            </h2>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-gray-100 text-xs uppercase tracking-wider text-gray-500 bg-white">
                        <th className="py-4 px-6 font-semibold">Arquivo / Local</th>
                        <th className="py-4 px-6 font-semibold text-right">Ação</th>
                      </tr>
                    </thead>
                    <tbody>
                      {driveItems.length === 0 && !loadingDrive ? (
                        <tr><td colSpan={2} className="py-12 text-center text-gray-500">Nenhum arquivo encontrado nas subpastas.</td></tr>
                      ) : (
                        driveItems.map((item) => (
